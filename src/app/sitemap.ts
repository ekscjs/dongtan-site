...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${base}/method`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.9 },
    { url: `${base}/method/pain-origin`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.8 },
    ...
    { url: `${base}/research-notes`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.6 },
