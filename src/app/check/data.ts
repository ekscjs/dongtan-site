...
export const resultTypes: Record<TypeKey, ResultType> = {
  neck: {
    ...
    routine: [
      { day: 1, title: "턱 당기기 (친 턱)", how: "벽에 등을 대고 턱을 살짝 뒤로 당겨 뒤통수를 벽에 가깝게. 5초 유지 후 풀기 × 10회.", point: "목이 길어지는 느낌", durationSec: 90 },
      { day: 2, title: "가슴 열기 (문틀 스트레칭)", how: "문틀에 팔꿈치를 대고 한 발 앞으로. 가슴 앞쪽이 늘어나게 30초 × 2회.", point: "가슴 앞쪽이 시원하게 늘어남", durationSec: 90 },
      { day: 3, title: "견갑 모으기", how: "팔을 살짝 벌리고 날개뼈를 등 가운데로 천천히 모았다 풀기 × 12회.", point: "등 가운데에 힘이 들어옴", durationSec: 90 },
      { day: 4, title: "상부 승모근 늘이기", how: "한 손으로 머리를 반대쪽으로 부드럽게 당겨 목옆을 늘림. 좌우 30초씩.", point: "목과 어깨 사이가 풀림", durationSec: 90 },
      { day: 5, title: "흉추 펴기 (벽 신전)", how: "등 위쪽만 벽/폼롤러에 기대 가슴을 위로 열며 신전 × 10회.", point: "굽은 등이 펴지는 느낌", durationSec: 120 },
      { day: 6, title: "누워서 턱 당기기", how: "바로 누워 뒤통수로 바닥을 가볍게 누르며 턱 당기기 5초 × 10회.", point: "목 깊은 근육이 켜짐", durationSec: 90 },
      { day: 7, title: "자세 리셋 통합", how: "1·3·5일 동작을 이어서 한 세트. 끝나고 바른 자세로 1분 호흡.", point: "상체 정렬을 몸이 기억", durationSec: 180 },
    ],
  },
  pelvis: {
    key: "pelvis",
